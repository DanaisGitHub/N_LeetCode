...
and
[5, 10]
, these overlap because the second meeting starts at time 5, which is before the first meeting ends at time 30. The person cannot attend both meetings.
If you have meetings
[0, 30]
and
[35, 50]
...
true
if the person can attend all meetings (no overlaps exist), and
false
